...
;*	September 28, 2022
;*
;*	Changes made to second ldi command in both HitRight 
;*		and HitLeft sub-routines
;*
;*	I doubled the time moving backwards by doubling WTime when moving backwards
;*
;***********************************************************
...
HitRight:
		...
		ldi		waitcnt, WTime*2	; Wait for 2 second
